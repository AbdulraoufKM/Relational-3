...
public class CourseController {
    ...
    @GetMapping("teacherByCourse/{courseId}")
    ...
    @GetMapping("/get-teacher-name/{teacherId}")
    public ResponseEntity getTeacherName(@PathVariable Integer teacherId){
        return ResponseEntity.status(200).body(courseService.getTeacherName(teacherId));
    }

    @GetMapping("/get-students/{courseId}")
    public ResponseEntity getAllStudent(@PathVariable Integer courseId){
